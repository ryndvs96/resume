...
\dates{\emph{Spring 2016 - Present}}
\begin{position}
A competitive programming group with weekly competitions and group discussions. There is emphasis on algorithms and optimization in regards to time complexity and memory management. Recently working on dynamic programming and analysis.
\end{position}
