...
\small{\textbf{Skilled}: }\normalsize{Java, C++}\\
\small{\textbf{Familiar}: }\normalsize{PHP, Haskell, SQL}\\
\small{\textbf{Exposure}: }\normalsize{NodeJS, Redis, Ruby, \LaTeX}
...
% \end{itemize}
\begin{itemize}
\item Learning to adapting quickly to new concepts and technologies.
\end{itemize}
\end{position}
...
%\employer{\textbf{Degrees of Friendship}}
%\dates{\emph{January 2016 - Present}}
%\begin{position}
%  Web app that will find a series of friendship connections between any two given people. 
%\end{position}
%\begin{itemize}
%\item Based upon the theory of Six Degrees of Separation and implemented via Twitter.
%\end{itemize}
%\begin{itemize}
%\item Constructing an efficient algorithm to find short paths of large database graphs.
%\end{itemize}
%\begin{itemize}
%\item The project is being developed in an Agile (Scrum) Team environment.
%\end{itemize}
...
%\textbf{\textcolor{black}{Board Game Optimization \emph{Java}}}\hfill\emph{Oct 2015 - Present}
%\begin{itemize}
%\setlength\itemsep{0.1pt}
%\item Engineered artificial intelligence to efficiently play the board game Telepathy.
%\item Assembled Decision Trees that result in a winning conclusion.
%\end{itemize} 
...
\dates{\emph{Spring 2016}}
\begin{position}
A competitive programming group with weekly competitions and group discussions. There is emphasis on algorithms and optimization in regards to time complexity and memory management.
\end{position}
...
%\employer{\textbf{Snowboarding}}
%\dates{}
%\begin{position}
%I enjoy snowboarding as a hobby because it gives a thrilling rush whilst still having a lot of soft padding if I wipeout. It allows me to take a short break when I want to hit the slopes with some pals and have an awesome time. 
%\end{position}
